...
export function MenuScreen({ onSignOut }: MenuScreenProps = {}) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.profileHeader}>
        <View style={styles.profileLeft}>
          ...
          <View>
            ...
            <Text style={[styles.profilePlan, { color: c.primaryContainer }]}>
              AURA LUXE PARTNER
            </Text>
          </View>
        </View>
      ...
      <View style={styles.aiBanner}>
        <View style={styles.aiBannerContent}>
          ...
          <Text style={styles.aiRemaining}>
            Remaining in your current cycle
          </Text>
      ...
      {categories.map((cat) => (
        <View key={cat.label} style={styles.categorySection}>
          <View style={styles.categoryHeader}>
            ...
            />
            <Text style={[styles.categoryLabel, { color: c.onSurfaceVariant }]}>
          ...
          <View style={styles.categoryGrid}>
            {cat.items.map((item) => (
              ...
              >
                <Text style={[styles.gridIcon, { color: cat.color }]}>
                  {item.icon}
                </Text>
                <Text style={[styles.gridLabel, { color: c.onSurface }]}>
      ...
      {/* Export Card */}
      <View
        style={[styles.exportCard, { backgroundColor: c.surfaceContainerLow }]}
      >
        <View style={styles.exportAccent} />
        <Text style={[styles.exportTitle, { color: c.onSurface }]}>
          Exportar Dados
        </Text>
        ...
        <TouchableOpacity style={styles.exportBtn}>
          <Text style={[styles.exportBtnText, { color: c.primaryContainer }]}>
            INICIAR EXPORTACAO
          </Text>
        </TouchableOpacity>
      </View>
      ...
      {onSignOut && (
        <TouchableOpacity
          ...
          style={[
            styles.exportBtn,
            { borderWidth: 1, borderColor: c.error, marginTop: 24 },
          ]}
        >
          <Text style={[styles.exportBtnText, { color: c.error }]}>SAIR</Text>
        </TouchableOpacity>
      )}
