...
import { classificationColors } from "@wbc/shared/theme";
...
export function Avatar({
  ...
  const initials = name
    ...
    .substring(0, 2)
    .toUpperCase();
  const bg = classification
    ? classificationColors[classification].bg
    : c.primaryContainer;
  const color = classification
    ? classificationColors[classification].text
    : c.onPrimary;
