  ...
  return (
    <Wrapper
      ...
      className={cn(
        ...
        onClick &&
          "w-full text-left hover:bg-[var(--color-bg-secondary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded-md px-2 -mx-2 transition-colors",
        className,
      )}
    >
